...
# create a matrix with the relevant features
...
# XGBoost model
model = xgb.XGBRegressor(gamma= 0.01, learning_rate= 0.05, max_depth= 25, min_child_weight= 1, n_estimators= 500, objective = 'reg:gamma', subsample= 0.4)
